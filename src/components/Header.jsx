...
const Header = () => {
  ...
  const { user, cerrarSesion, nombreRefugio, cargando } = useAuth();
  ...
  return (
    <header className="bg-[#FFE5B4] text-[#4D2600] shadow p-4">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div
          className={`flex-col lg:flex-row lg:flex lg:items-center lg:space-x-6 absolute lg:static top-20 left-0 w-full lg:w-auto bg-[#FFE5B4] p-4 lg:p-0 shadow-md lg:shadow-none ${
